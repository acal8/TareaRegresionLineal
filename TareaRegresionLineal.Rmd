...
plot(boston$medv, boston$crim, col = 'black', main = "Diagrama de dispersión", xlab = "medv", ylab = "crim")
abline(coef = coef(lm_crim_medv), lwd = 2, col = 'red')
lines(sort(boston$medv), fitted(lm_medv_trans)[order(boston$medv)], col = 'darkcyan', lwd = 3, lty = 2)
