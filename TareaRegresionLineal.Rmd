...
```
Observamos que la variable más significativa es lstat con el p-value más pequeño, por lo que deducimos que es la variable con la que tiene mayor relación lineal. 
...
Vemos que pese a que la variable sea muy significativa, en el gráfico de dispersión la relación es de fuerza baja o moderada, ya que los puntos no se agrupan alrededor de una línea y se observa un aumento en la dispersión de crim a medida que lstat aumenta. Este efecto es un posible indicador de heterocedasticidad, ya que muestra que la varianza no es constante.
