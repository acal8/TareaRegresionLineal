...
Observamos que con nuestro nuevo modelo obtenemos un valor $R^2$ ajustado de $0.6671$, es decir, explicamos aproximadamente $2/3$ de la varianza de la variable `crim`.
