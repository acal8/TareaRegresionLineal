...
siendo $\beta_0 =$ `r lm_crim_medv$coefficients[1]` el intercepto y $\beta_1 =$ `r lm_crim_mdev$coefficients[2]` la pendiente de la recta.
...
plot(boston$medv + (boston$medv)^2, boston$crim, main = "Diagrama de dispersión", xlab = "medv con transformación sqrt", ylab = "crim con transformación logarítmica")
