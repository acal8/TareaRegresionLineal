...
_Ejercicio 1:_ Considera la variable respuesta `crim` relacionándola con la variable `X` con la que tenga mayor relación lineal.
...
_Ejercicio 2:_ Considera la variable respuesta `crim` relacionándola con el predictor `medv`.
